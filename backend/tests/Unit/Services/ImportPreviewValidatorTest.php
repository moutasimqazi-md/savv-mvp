...
class ImportPreviewValidatorTest extends TestCase
{
    ...
    {
        $result = ImportPreviewValidator::validateScanResult([$this->validOrder()], Provider::AmazonUs);
    ...
    public function test_rejects_order_missing_provider_order_id(): void
    {
        ...
        $this->expectException(InvalidArgumentException::class);
        ImportPreviewValidator::validateScanResult([$order], Provider::AmazonUs);
    }
    ...
    public function test_strips_html_from_item_titles(): void
    {
        ...
        $result = ImportPreviewValidator::validateScanResult([$order], Provider::AmazonUs);
